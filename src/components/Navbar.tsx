    ...
    <nav className="fixed top-0 w-full z-50 bg-[#ffe6ef]/80 backdrop-blur-md border-b border-pink-200">
      <div className="max-w-6xl mx-auto px-4 h-16 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-6 items-center font-bold text-pink-400">
          ...
          <a href="https://discord.gg/fTnp3CGqHr" target="_blank" rel="noreferrer" className="bg-[#5865F2] text-white px-5 py-2 rounded-full hover:bg-[#4752C4] transition shadow-lg shadow-indigo-200 flex items-center gap-2">
